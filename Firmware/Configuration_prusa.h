...
// Printer name
#define CUSTOM_MENDEL_NAME "MKP15"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,3200/8,143, 143}
...
#define NUM_AXIS 5 // The axis order in all axis related arrays is X, Y, Z, E, A
...
#define DEFAULT_MAX_FEEDRATE                {210, 200, 12, 120, 80}      // (mm/sec)   max feedrate (M203)
#define DEFAULT_MAX_FEEDRATE_SILENT         {100, 100, 12, 120, 80}      // (mm/sec)   max feedrate (M203), silent mode

#define DEFAULT_MAX_ACCELERATION            {1000, 1000, 200, 5000, 4000}  // (mm/sec^2) max acceleration (M201)
#define DEFAULT_MAX_ACCELERATION_SILENT     {960, 960, 200, 5000, 4000}    // (mm/sec^2) max acceleration (M201), silent mode


#define DEFAULT_ACCELERATION          1250   // X, Y, Z and E max acceleration in mm/s^2 for printing moves (M204S)
#define DEFAULT_RETRACT_ACCELERATION  1250   // X, Y, Z and E max acceleration in mm/s^2 for retracts (M204T)

#define MANUAL_FEEDRATE {2700, 2700, 1000, 100, 80}   // set the speeds for manual moves (mm/min)
