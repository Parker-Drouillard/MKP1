...
#define SD_FINISHED_RELEASECOMMAND "M84 X Y Z E A" // You might want to keep the z enabled so your bed stays in place.
...
*/
    ...
    //#define SORTING_DUMP
	  ...
	  #define SDSORT_LIMIT       5    // Maximum number of sorted items (10-256).
